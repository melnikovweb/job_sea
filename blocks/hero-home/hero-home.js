...
const homeHero = {
  init: () => {
    const heroBtn = document.querySelector(".hero-home .hero-home-video-link");
    ...
    document.addEventListener('click', (e) => {
      if(e.target.classList.contains('hero-home-play-btn')) {
        playPauseIframe();
      }
      if(e.target.classList.contains('hero-mobile-play-btn')) {
